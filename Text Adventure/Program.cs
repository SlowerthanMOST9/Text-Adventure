...
namespace ChooseYourOwnAdventure
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("You walk into the hallway and see a light coming from under the door down the hall.");
                ...
                else if (doorChoice == "OPEN")
                {
                    ...
                    {
                        case "1":
                            Console.WriteLine("You choose the first key. Lucky chloice!");
